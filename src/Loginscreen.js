...
class Loginscreen extends Component {
  constructor(props){
    ...
    loginButtons.push(
      ...
      <MuiThemeProvider>
        <div>
           <RaisedButton label={"Register as VanHack Talent"} primary={true} style={style} onClick={(event) => this.handleClick(event,'talent')}/>
       </div>
       </MuiThemeProvider>
       <MuiThemeProvider>
       <div>
          <RaisedButton label={"Register as VanHack Company"} primary={true} style={style} onClick={(event) => this.handleClick(event,'company')}/>
      </div>
      </MuiThemeProvider>
      </div>
    )
    this.state={
      ...
      studentbuttonLabel:'Register as VanHack Talent',
      teacherbuttonLabel:'Register as VanHack Company',
      isLogin:true
    }
  }
  componentWillMount(){
